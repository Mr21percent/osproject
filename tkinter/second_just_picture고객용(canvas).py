...
c2.create_text(57,10,text=mci[nu][0])
c3.create_text(50,10,text=mci[nu][4])
c4.create_text(20,10,text='원 결제 금액')
c5.create_text(35,10,text='<금액 출력>')
c6.create_text(37,10,text='실 결제 금액')
c7.create_text(35,10,text=mci[nu][3])
...
def nextc():
    ...
    print(nu)
    c2["text"]=mci[nu][0]
b1 = Button(window, text = 'left', command=nextc)
